...
export const metadata: Metadata = {
  ...
  description: 'Vitaminler, dusunce_yazilarim protokolleri, biyokimya analizi ve metabolik sağlık yönetimi.',
}

export default function BeslenmePage() {
  const articles = getArticlesByCategory('dusunce_yazilarim')
